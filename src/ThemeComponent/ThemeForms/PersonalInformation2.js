import { Stack, TextField, FormControlLabel, Radio, FormControl, Box, RadioGroup, Select as SelectField, MenuItem, Select } from "@mui/material";
...
import { MaritalStatus, CandidateEducation } from "../../utils/Data";
            ...
            {({ errors, touched, values, setFieldValue }) => (
                <Form className="ProfessionalDetailForm">
                    <ThemeFInputDiv>
                        ...
                        <ThemeFInputDiv>
                            <ThemeLabel LableFor="bank_account" LableText="Name" />
                            <Field
