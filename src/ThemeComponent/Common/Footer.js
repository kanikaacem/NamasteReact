    ...
    return (<>
        <Stack direction="column" className="websiteFooter" gap={2} sx={{
            ...
            <Grid container spacing={2}>
                <Grid item xs={6} md={3}>
                    <Stack direction="column" gap={2} className="CompanyInformation" >
                ...
                <Grid item xs={6} md={3}>
                    <Stack direction="column" gap={2} className="LegalInformation" >
                ...
                <Grid item xs={6} md={3}>
                    <Stack direction="column" gap={2} className="RecruiterLogin">
