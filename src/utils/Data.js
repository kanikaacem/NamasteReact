...
export const AccountSettingMenu = [
    {
        id: 1,
        menu_name: "create_sub_user",
    },
    {
        id: 2,
        menu_name: "company_information",
    },
    {
        id: 3,
        menu_name: "account_setting",
    },
    {
        id: 4,
...
/*Cities Data */
export const cities = [
    { id: 1, name: "Faridabad", value: "faridabad" },
    { id: 3, name: "UP", value: "up" },
    { id: 4, name: "Noida", value: "noida" }
]

/* Experience Data */
export const Experience = [
    { id: 1, name: '1-2 Yrs', value: '1-2' },
    { id: 2, name: '2-3 Yrs', value: '2-3' },
    { id: 3, name: '3-4 Yrs', value: '3-4' },
    { id: 4, name: '4-5 Yrs', value: '4-5' },
    { id: 5, name: '5-6 Yrs', value: '5-6' },
    { id: 6, name: '6-7 Yrs', value: '6-7' },
    { id: 7, name: '7-8 Yrs', value: '7-8' },
    { id: 8, name: '8-9 Yrs', value: '8-9' },
    { id: 9, name: '9-10 Yrs', value: '9-10' }

]

/*Opening Data */
/* Job Filter for filtering the Job*/
export const filter = [
    {
        id: 1,
        text: 'Any Exp. Level'
...
export const CompanyType = [
    {
        id: 1,
        value: "funded_startup_(running_operation)",
        name: "Funded Startup (Running Operation)"
    },
    {
        id: 2,
        value: "startup_(more_than_30_emp)",
        name: "Midsize Company (More than 30 emp )"
    },
    {
        id: 3,
        value: "midsize_company_(company_vintage)",
        name: "Midsize Company (Company Vintage )"
    },
    {
        id: 4,
...
/*Perferred Location */
export const PerferredLocation = [
